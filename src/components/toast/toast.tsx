...
type TToastProvider = React.FC<ToastPrimitives.ToastProviderProps>
const ToastProvider:TToastProvider = ToastPrimitives.Provider
...
type toastVariants = (props?: ConfigVariants<{
  variant: {
    default: string;
    destructive: string;
  };
...
const toastVariants:toastVariants = cva(
